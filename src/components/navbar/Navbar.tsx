    ...
    <nav className="h-14 border-b border-gray-800 bg-background flex items-center justify-between px-4">
      ...
      <div className="flex items-center gap-3">
        <div className="flex gap-1 bg-panel p-1 rounded-md border border-gray-800">
          <Button active onClick={handleLoadAudio}>
            +Audio
          </Button>
        ...
        >
          <option value="1080" className="bg-gray-900 text-gray-200">
            1080p
          </option>
          <option value="720" className="bg-gray-900 text-gray-200">
            720p
          </option>
          <option value="480" className="bg-gray-900 text-gray-200">
            480p
          </option>
        </select>
        <Button
          ...
          onClick={() => {
            const res = parseInt(
              (document.getElementById("res-select") as HTMLSelectElement)
                .value,
            ) as 480 | 720 | 1080;
            exportVideo(res);
          }}
