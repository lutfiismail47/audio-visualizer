...
function App() {
  const { isExporting, isComplete, errorText, progress, statusText, resetExportState } = useExportStore();
          ...
          <div className="w-full max-w-md bg-panel border border-gray-800 rounded-2xl p-6 flex flex-col items-center text-center shadow-2xl">
            {errorText ? (
              <>
                ...
                <h2 className="text-xl font-bold mb-2 text-white">Ekspor Gagal</h2>
              ...
              <>
                ...
                <h2 className="text-xl font-bold mb-2 text-white">Ekspor Selesai!</h2>
                <p className="text-gray-400 text-sm mb-6">Video berhasil dirender dan disimpan.</p>
                <button 
                  onClick={resetExportState}
              ...
              <>
                <h2 className="text-xl font-bold mb-2 text-white">Mengekspor Video</h2>
