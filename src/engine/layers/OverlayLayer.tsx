...
const DraggableOverlay: React.FC<DraggableProps> = ({
  ...
  if (!isExporting) {
    switch (overlay.animation) {
      case "Pan":
        ...
        break;
      case "Denyut":
        animClass = "anim-denyut";
        baseDuration = 2;
        break;
      case "Blitz":
        animClass = "anim-blitz";
        baseDuration = 0.15;
        break;
      case "Float":
      ...
      case "Zoom":
        ...
        baseDuration = 2;
        break;
      case "Putar searah jarum jam":
        animClass = "anim-putar";
        baseDuration = 10;
        break;
      case "Putar kebalikan arah jarum jam":
        animClass = "anim-putar-ccw";
        baseDuration = 10;
        break;
    }
  }
  ...
  const isBeatAnim = ["Denyut", "Zoom", "Shake", "Pan", "Blitz"].includes(
    overlay.animation,
  );
  const animDuration =
    overlay.animation === "Tanpa anim" || isBeatAnim
      ? undefined
  ...
  return (
    ...
    >
      ...
      >
        <div
          className={`${animClass} w-full h-full flex items-center justify-center transition-transform duration-75 ease-out`}
          style={{
